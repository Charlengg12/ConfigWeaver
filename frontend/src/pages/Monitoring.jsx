...
const Monitoring = () => {
    ...
    // Assuming Grafana is running on localhost:3000 and has a dashboard with UID 'configweaver'
    // using "d-solo" for single panels or "d" for full dashboard
    const GRAFANA_URL = "http://localhost:3000/d/configweaver-main?orgId=1&kiosk=tv";
